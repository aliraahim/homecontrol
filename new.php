...
<div id="timer" class="overlay">
    ...
    <div class="overlay-content">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <form action = "timer.php" method = "POST" class="form-inline timerForm">
<!--                        <label class="" for="inlineFormCustomSelect">Turn</label>-->
                        ...
                        <input type="number" class="form-control" name="number" id = "hours-mins" min="1" max="2000" placeholder="5" required>
